/*
MC Dec-16 : Identical to material.js except I triggered a custom event when material.init() finishes so that
we can load pages properly...
...
(function($) {
  ...
  $.material =  {
    ...
    "init": function() {
      ...
      $(document).trigger("ohm_material", ["init"])
    }
  };
